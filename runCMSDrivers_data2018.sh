...
echo "------------------------------"
cmsDriver.py step3 --conditions auto:run2_data_FULL -n 5 --era Run2_2018 -s RAW2DIGI,L1Reco,RECO,EI --data --datatier AOD --eventcontent AOD --filein file:output_step2_HLT.root --fileout output_step3_AOD.root --customise_commands='process.GlobalTag.DumpStat =cms.untracked.bool(True)' |& tee output_step3_AOD.log

#4 MINIAOD
echo "------------------------------"
echo "Running step-4/5: MINIAOD"
echo "------------------------------"
cmsDriver.py step4 --runUnscheduled --conditions auto:run2_data_FULL -n 5 --era Run2_2018 -s PAT --data --datatier MINIAOD --eventcontent MINIAOD --filein file:output_step3_AOD.root --fileout output_step4_MINIAOD.root --customise_commands='process.GlobalTag.DumpStat =cms.untracked.bool(True)' |& tee output_step4_MINIAOD.log

#5 NANOAOD
echo "------------------------------"
echo "Running step-5/5: NANOAOD"
echo "------------------------------"
cmsDriver.py step5 --runUnscheduled --conditions auto:run2_data_FULL -n 5 --era Run2_2018 -s NANO --data --datatier NANOAOD --eventcontent NANOAOD --filein file:output_step4_MINIAOD.root --fileout output_step5_NANOAOD.root --customise_commands='process.GlobalTag.DumpStat=cms.untracked.bool(True)' |& tee output_step5_NANOAOD.log
